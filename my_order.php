        ...
        if($status=="Not Finish")
        {
            ...
            <tbody>
                <tr>
                    ...
                    <form method="post">
                        <input type="submit" name="button_cancel" class="btn btn-danger" value="Cancel" /> 
...
if ($num > 0) {
    for ($i = 0; $i < $num; $i++) {
        ...
        $OID3 = "myorder".$OID;
        $content = <<<EOF
                    <div class="modal fade" id=$OID3 data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
...
if(array_key_exists('button_cancel', $_POST)) {
    $oid = $_POST["OID"];
    button_cancel($oid);
}
function button_cancel($oid) {
